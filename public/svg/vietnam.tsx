...
const VietNamSVG = ({ width = 24, height = 24 }: VietNamSVGProps) => {
    return (
        <svg
            version="1.1"
            id="Layer_1"
        ...
        >
            <g>
                <path
                    fill= "#DA251D"
                    d="M3.01,0h49.17c1.66,0.01,3.01,1.37,3.01,3.03v32.33c0,1.66-1.35,3.02-3.01,3.03H3.01C1.35,38.39,0,37.03,0,35.37V3.03C0,1.37,1.35,0.01,3.01,0L3.01,0z"
                />
                <path
                    fill= "#FFFF00"
                ...
                <path
                     fill= "#FFFF00"
                    d="M32.11,25.41l-2.37-7.3l-4.87,1.58L32.11,25.41L32.11,25.41z M32.11,25.41L32.11,25.41L32.11,25.41L32.11,25.41z"
                />
                <path
                     fill= "#FFFF00"
                    d="M32.11,25.41L25.9,20.9l3.01-4.14L32.11,25.41L32.11,25.41z M32.11,25.41L32.11,25.41L32.11,25.41L32.11,25.41z"
                />
                <path
                     fill= "#FFFF00"
                ...
                <path
                     fill= "#FFFF00"
                    d="M23.09,25.41l6.21-4.51l-3.01-4.14L23.09,25.41L23.09,25.41z M23.09,25.41L23.09,25.41L23.09,25.41L23.09,25.41z"
                />
            </g>
        </svg>
    );
