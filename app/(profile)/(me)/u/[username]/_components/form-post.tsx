...
import { Loader, Earth, Lock } from "lucide-react";
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="flex space-x-4">
                    <div
                      onClick={() => {
                        setIsPublic(true); // Set state to true for Công khai
                        field.onChange(true); // Update form field
                      }}
                      className={`cursor-pointer px-4 py-2 rounded-md text-white flex items-center ${
                        isPublic ? "border border-green-600 " : ""
                      }`}
                    >
                    ...
                    <div
                      onClick={() => {
                        setIsPublic(false); // Set state to false for Cá nhân
                        field.onChange(false); // Update form field
                      }}
                      className={`cursor-pointer px-4 py-2 rounded-md text-white flex items-center ${
                        !isPublic ? "border border-green-600" : ""
                      }`}
