...
import { translateActionMessages } from "@/translate/translate-client";
...
const ConversationBox: React.FC<ConversationBoxProps> = ({ 
  ...
  const actionMessage = translateActionMessages(language)
  ...
  const lastMessageText = useMemo(() => {
    if (lastMessage?.image) {
      return actionMessage.sentImage;
    }
    ...
    return actionMessage.startedConversation;
  }, [lastMessage]);
  ...
  useEffect(() => {
    const fetchUnseenMessages = async () => {
      try {
        ...
        console.error(actionMessage.failedToFetchUnseenMessages);
      }
    };
