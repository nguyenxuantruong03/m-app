...
import { getCategoriesClient, getEnterNameTranslation, translateCategoriesClientPin } from "@/translate/translate-dashboard";
...
const CategoriesClient: React.FC<CategoriesClientProps> = ({ data }) => {
  ...
  const categoriesClientPinMessage = translateCategoriesClientPin(languageToUse)
  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <Heading
          title={`${categoriesClientPinMessage.categoryPin} (${data.length})`}
          description={categoriesClientPinMessage.manageCategoryPin}
        />
