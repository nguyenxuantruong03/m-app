...
const ProductPage = async ({params}:{params: {storeId: string,product4Id: string}}) => {
    const product = await prismadb.product4.findUnique({
        where:{
    ...
    const categories = await prismadb.category4.findMany({
        where:{
