...
import { getEnterNameTranslation, getProductClient, translateProductsClientCuttingStone } from "@/translate/translate-dashboard";
...
const ProductClient: React.FC<ProductClientProps> = ({ data }) => {
  ...
  const productClientCuttingStoneMessage = translateProductsClientCuttingStone(languageToUse);
  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <Heading
          title={`${productClientCuttingStoneMessage.productCuttingStone} (${data.length})`}
          description={productClientCuttingStoneMessage.manageProductCuttingStone}
        />
        <div className="flex space-x-3">
          ...
          />
          <Button
            onClick={() => router.push(`/${params.storeId}/product4/new`)}
          >
