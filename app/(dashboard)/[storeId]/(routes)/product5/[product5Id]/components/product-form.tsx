...
import { Category5, Product5, Image5, Size, Color, Specifications,Salientfeatures } from "@prisma/client"
  ...
  const onSubmit = async (data: ProductFormValues) => {
    try {
     ...
     /* Khối mã chịu trách nhiệm thực hiện yêu cầu HTTP để cập nhật bảng quảng cáo hiện có
      ...
      if (initialData) {
        await axios.patch(`/api/${params.storeId}/product5/${params.product5Id}`, data);
      } else {
