...
import { getCategories5 } from "@/actions/client/categories/get-categories";
...
const CategoryPage: React.FC<CategoryPageProps> = ({
  ...
  return (
      <Category5 params={params} searchParams={searchParams} />
  );
};
...
export async function generateMetadata({
  ...
  const categories = await getCategories5(languageToUse);
