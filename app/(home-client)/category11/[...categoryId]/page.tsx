import { getCategories11 } from "@/actions/client/categories/get-categories";
...
const CategoryPage: React.FC<CategoryPageProps> = ({
  ...
  return (
    <Container>
      <Category11 params={params} searchParams={searchParams} />
    </Container>
  );
};
...
export async function generateMetadata({
  ...
  const categories = await getCategories11(languageToUse);
