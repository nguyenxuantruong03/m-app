...
const ComfirmationProduct = () => {
  ...
  useEffect(() => {
    if (loading ) {
      ...
      document.title = t("warehouse.waitingforConfirmation");
    }
  }, [loading]);
                ...
                return (
                  <>
                    <div
                      ...
                      onClick={() =>
                        router.push(
                          `/warehouse/package-product/confirmation-product/${order.id}`
                        )
                      }
                    >
                      {openReturnProduct && (
...
export default ComfirmationProduct;
