...
const NavbarDelivery = () => {
  ...
  const navbarOrder = [
    ...
    },
    {
      ...
      label: t("warehouse.navbar.confirmOrder"),
    ...
    },
    {
      ...
      label: t("warehouse.navbar.prepareOrder"),
    ...
    },
    {
      ...
      label: t("warehouse.navbar.waitingForDelivery"),
      active: pathname.startsWith(
    ...
    },
    {
      ...
      label: t("warehouse.navbar.delivering"),
      active: pathname.startsWith(
    ...
    },
    {
      ...
      label: t("warehouse.navbar.completed"),
      active: pathname.startsWith(
    ...
    },
    {
      ...
      label: t("warehouse.navbar.cancelledOrReturned"),
