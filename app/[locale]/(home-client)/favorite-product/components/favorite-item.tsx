      ...
      <div className="relative" onClick={handleClick}>
        <div className="bg-white group cursor-pointer rounded-xl border p-3 space-y-4">
          ...
          <div>
            <div className="grid grid-cols-2">
              ...
              <p>
                <span className="text-sm text-gray-600">{t("product.size")}:</span>
            ...
            <div className="grid grid-cols-2">
              ...
              <p className="flex items-center">
                <span className="text-sm text-gray-600">{t("product.color")}:</span>
                <div
        ...
        {getPriceMatchColorandSize().percentpromotion > 0 && (
          <div className="home-product-item__favorite">
            <span className="ml-1">
              {t("action.decrease")} {getPriceMatchColorandSize().percentpromotion}%
            </span>
          </div>
        )}
      </div>
