    ...
    if (inputValue !== null && inputValue >= 1 && inputValue <= 5) {
      ...
      axios
        ...
        .then((response) => {
          setLoading(false);
          router.refresh();
          setSuccessMessage(t("formInfo.deviceLimitChanged", {}));
        })
        .catch((error) => {
          if (
            ...
            setLoading(false);
            setErrorMessage(t("toastError.somethingWentWrong"));
          }
        });
    } else {
      setErrorMessage(t("formInfo.deviceLimitError"));
      setLoading(false);
    }
  };
  // TODO
  ...
  return (
    <div>
      <Input
        ...
        max="5"
        pattern="^[1-9]$|^5$"
        placeholder={t("formInfo.deviceLimitInputPrompt")}
