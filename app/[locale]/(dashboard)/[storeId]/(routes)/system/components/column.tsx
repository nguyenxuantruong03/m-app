...
const HeaderColumn = ({
  ...
  column: any;
  labelKey: keyof SystemHeaderMessage;
  icon: React.ElementType;
}) => {
    const translate = useTranslations("column.system"); 
...
export const columns: ColumnDef<SystemsColumn>[] = [
  {
    ...
    header: ({ column }) => (
      <HeaderColumn column={column} labelKey="old" icon={Minus} />
    ),
    cell: ({ row }) => {
  ...
  },
  {
    ...
    header: ({ column }) => (
      <HeaderColumn column={column} labelKey="new" icon={Plus} />
    ),
    cell: ({ row }) => {
      const isBanForeverUser = row.original.type === "BANFOREVER-USER";
      return (
  ...
  },
  {
    accessorKey: "delete",
    header: ({ column }) => (
      <HeaderColumn column={column} labelKey="delete" icon={Trash} />
    ),
    cell: ({ row }) => {
      const isBanForeverUser = row.original.type === "BANFOREVER-USER";
      return (
  ...
  },
  {
    accessorKey: "type",
    header: ({ column }) => (
      <HeaderColumn column={column} labelKey="type" icon={Tag} />
    ),
    cell: ({ row }) => {
      const isBanForeverUser = row.original.type === "BANFOREVER-USER";
      return (
