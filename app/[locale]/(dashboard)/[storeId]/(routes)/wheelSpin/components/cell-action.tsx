    ...
    try {
      ...
      await toast.promise(
        promise.then(() => {
          return (
            <p>
              {t("spinLucky.cellaction.bonusUser")}: {data.email}
              {t("spinLucky.cellaction.content")}{" "}
              <span className="font-bold">{bonusTitle}</span>.
              {t("spinLucky.cellaction.addedBonus")}{" "}
              <span className="font-bold">
                +{newBonus}
                {t("spinLucky.cellaction.rotation")}
              </span>{" "}
              {t("spinLucky.cellaction.and")}{" "}
              <span className="font-bold">
                +{newCoins}
                {t("spinLucky.cellaction.coin")}
              </span>
              . {t("spinLucky.cellaction.total")}{" "}
        ...
        {
          loading: t("spinLucky.cellaction.updatingBonus"),
          success: (message) => {
            router.refresh();
            return message;
          },
    ...
    try {
      ...
      await toast.promise(
        promise.then(() => {
          return (
            <p>
              {t("spinLucky.cellaction.unbonusUser")}: {data.email}
              {t("spinLucky.cellaction.content")}{" "}
              <span className="font-bold">{unbonusTitle}</span>.{" "}
              {t("spinLucky.cellaction.deducted")}{" "}
              <span className="font-bold">
                {newBonus}
                {t("spinLucky.cellaction.rotation")}
              </span>{" "}
        ...
        {
          loading: t("spinLucky.cellaction.updatingUnbonus"),
          success: (message) => {
            router.refresh();
            return message;
          },
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        ...
        <DropdownMenuItem onClick={() => setOpenBonus(true)}>
          ...
          {t("spinLucky.cellaction.bonus")}
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => setOpenUnbonus(true)}>
          <WalletCards className="h-4 w-4 mr-2" />
          {t("spinLucky.cellaction.unbonus")}
        </DropdownMenuItem>
      </DropdownMenuContent>
        ...
        <div className="overlay" onClick={handleCloseModal}>
          <div className="modal z-[999] rounded-md" onClick={handleModalClick}>
            <Input
              ...
              placeholder={t("spinLucky.cellaction.enterTitle")}
              disabled={loading}
            />
            <Input
              type="number"
              ...
              placeholder={t("spinLucky.cellaction.enterBonusRotation")}
              disabled={loading}
              className="mt-3"
            />
            <Input
              ...
              placeholder={t("spinLucky.cellaction.enterCoin")}
              disabled={loading}
              className="mt-3"
            />
        ...
        <div className="overlay" onClick={handleCloseModal}>
          <div className="modal z-[999] rounded-md" onClick={handleModalClick}>
            ...
            <Input
              ...
              placeholder={t("spinLucky.cellaction.enterUnbonusRotation")}
              disabled={loading}
              className="mt-3"
            />
            <Input
              ...
              placeholder={t("spinLucky.cellaction.enterUncoin")}
              disabled={loading}
              className="mt-3"
            />
            <div className="flex justify-between px-2 mt-3">
