...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
  ...
  const onCopy = (id: string) => {
    ...
    toast.success(t("shippingrate.cellaction.copiedShippingRateId"));
  };
  ...
  const onDelete = async () => {
    try {
      ...
      router.refresh();
      toast.success(t("shippingrate.cellaction.shippingRatesDeleted"));
    } catch (error: unknown) {
      if (
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/${params.storeId}/shippingrates/${data.id}`)
            }
          >
