...
export const ProductDetailForm: React.FC<ProductDetailFormProps> = ({
  ...
  const formSchema = z.object({
    title: z
      .string()
      .min(2, { message: t("productdetail.form.minTwoCharacters") }),
    promotionheading: z
      .string()
      .min(2, { message: t("productdetail.form.minTwoCharacters") }),
    ...
    size1Id: z
      .string()
      .min(1, { message: t("productdetail.form.chooseValidSize") }),
    color1Id: z
      .string()
      .min(0, { message: t("productdetail.form.chooseValidColor") }),
    ...
    price1: z.coerce
      .number()
      .min(500, { message: t("productdetail.form.minAmount") }),
    ...
    percentpromotion1: z.optional(
      z.coerce
        ...
        .int()
        .min(0)
        .max(100, { message: t("productdetail.form.percentageRange") })
    ),
    ...
    quantity1: z.coerce
      .number()
      .int()
      .min(1, { message: t("productdetail.form.quantityRange") })
      .max(9999, { message: t("productdetail.form.quantityRange") }),
    ...
    categoryId: z
      .string()
      .min(1, { message: t("productdetail.form.chooseValidCategory") }),
  });

  type ProductDetailFormValues = z.infer<typeof formSchema>;

  const title = initialData
    ? t("productdetail.form.editProductDetail")
    : t("productdetail.form.createProductDetail");
  const description = initialData
    ? t("productdetail.form.editAProductDetail")
    : t("productdetail.form.addNewProductDetail");
          ...
          if (initialData) {
            ...
            return (
              <p>
                ...
                {t("productdetail.form.created")}.
              </p>
            );
          }
        }),
        {
          loading: t("productdetail.form.updatingProductDetail"),
          success: (message) => {
            router.refresh();
  ...
  const onDelete = async () => {
    try {
      ...
      router.refresh();
      router.push(`/${params.storeId}/productdetail`);
      toast.success(t("productdetail.form.productDeleted"));
    } catch (error: unknown) {
      if (
        (error as { response?: { data?: { error?: string } } }).response &&
          ...
          <div className="md:grid md:grid-cols-6 gap-6 overflow-y-auto">
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="flex space-x-3 items-center">
                    {t("productdetail.form.title")}
                    <span className="text-red-600 pl-1">(*)</span>
                    <Recommend message={t("productdetail.form.enterTitle")} />
                  </FormLabel>
                  <FormControl>
                    <Input
                      id="title-input"
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterTitlePlaceholder")
                      }
                      {...field}
                    />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="flex space-x-3 items-center">
                    {t("productdetail.form.productName1")}
                    <span className="text-red-600 pl-1">(*)</span>
                    <Recommend
                      message={t("productdetail.form.enterProductName1")}
                    />
                  </FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterProductName1Placeholder")
                      }
                      {...field}
                      onChange={(event) => {
              ...
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="flex space-x-3 items-center">
                        {t("productdetail.form.productPrice1")}{" "}
                        <span className="text-red-600 pl-1">(*)</span>
                        <Recommend
                          message={t("productdetail.form.enterProductPrice1")}
                        />
                      </FormLabel>
                      <FormControl>
                        <Input
                          ...
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterProductPrice1Placeholder")
                          }
                          {...field}
                          className="border-2 border-orange-400 "
                        />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="flex space-x-3 items-center">
                        {t("productdetail.form.discountProduct1")}{" "}
                        <span className="text-red-600 pl-1">(*)</span>
                        <Recommend
                          message={t("productdetail.form.discountDescription")}
                        />
                      </FormLabel>
                      <FormControl>
                        <Input
                          ...
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterDiscountProduct1")
                          }
                          {...field}
                          className="border-2 border-orange-400 "
                        />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="flex space-x-3 items-center">
                        {t("productdetail.form.stockProduct1")}{" "}
                        <span className="text-red-600 pl-1">(*)</span>
                        <Recommend
                          message={t("productdetail.form.stockDescription")}
                        />
                      </FormLabel>
                      <FormControl>
                        <Input
                          ...
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterStockProduct1")
                          }
                          {...field}
                          className="border-2 border-orange-400 "
                        />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productName2")}</FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterProductName2Placeholder")
                      }
                      {...field}
                      onChange={(event) => {
              ...
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productPrice2")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterProductPrice2Placeholder")
                          }
                          {...field}
                          className="border-2 border-green-400 "
                        />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.discountProduct2")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterDiscountProduct2")
                          }
                          {...field}
                          className="border-2 border-green-400 "
                        />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.stockProduct2")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterStockProduct2")
                          }
                          {...field}
                          className="border-2 border-green-400 "
                        />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productName3")}</FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterProductName3Placeholder")
                      }
                      {...field}
                      onChange={(event) => {
              ...
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productPrice3")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterProductPrice3Placeholder")
                          }
                          {...field}
                          className="border-2 border-sky-400 "
                        />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.discountProduct3")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterDiscountProduct3")
                          }
                          {...field}
                          className="border-2 border-sky-400 "
                        />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.stockProduct3")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterStockProduct3")
                          }
                          {...field}
                          className="border-2 border-sky-400 "
                        />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productName4")}</FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterProductName4Placeholder")
                      }
                      {...field}
                      onChange={(event) => {
              ...
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productPrice4")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterProductPrice4Placeholder")
                          }
                          {...field}
                          className="border-2 border-violet-400 "
                        />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.discountProduct4")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterDiscountProduct4")
                          }
                          {...field}
                          className="border-2 border-violet-400 "
                        />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.stockProduct4")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterStockProduct4")
                          }
                          {...field}
                          className="border-2 border-violet-400 "
                        />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productName5")}</FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterProductName5Placeholder")
                      }
                      {...field}
                      onChange={(event) => {
              ...
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productPrice5")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterProductPrice5Placeholder")
                          }
                          {...field}
                          className="border-2 border-pink-400 "
                        />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.discountProduct5")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterDiscountProduct5")
                          }
                          {...field}
                          className="border-2 border-pink-400 "
                        />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.stockProduct5")}
                      </FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          disabled={loading}
                          placeholder={
                            t("productdetail.form.enterStockProduct5")
                          }
                          {...field}
                          className="border-2 border-pink-400 "
                        />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="flex space-x-3 items-center">
                    {t("productdetail.form.wholesaleDiscount")}{" "}
                    <span className="text-red-600 pl-1">(*)</span>
                    <Recommend
                      message={t("productdetail.form.wholesaleDescription")}
                    />
                  </FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterWholesaleDiscount")
                      }
                      {...field}
                    />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="flex space-x-3 items-center">
                    {t("productdetail.form.contractorDiscount")}{" "}
                    <span className="text-red-600 pl-1">(*)</span>
                    <Recommend
                      message={t("productdeatil.form.contractorDescription")}
                    />
                  </FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterContractorDiscount")
                      }
                      {...field}
                    />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="flex items-center">
                    <span className="mr-3">
                      {t("productdetail.form.warrantyPrice1")}{" "}
                    </span>
                    <Recommend
                      message={t("productdetail.form.warrantyDescription")}
                    />
                  </FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterWarrantyPrice1")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    {t("productdetail.form.warrantyPrice2")}
                  </FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterWarrantyPrice2")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    {t("productdetail.form.warrantyPrice3")}
                  </FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterWarrantyPrice3")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    {t("productdetail.form.warrantyPrice4")}
                  </FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterWarrantyPrice4")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="flex space-x-3 items-center">
                    {t("productdetail.form.specifications")}{" "}
                    <span className="text-red-600 pl-1">(*)</span>
                    <Recommend
                      message={t("productdetail.form.enterSpecifications")}
                    />
                  </FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterSpecificationsPlaceholder")
                      }
                      {...field}
                      onChange={(event) => {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="flex space-x-3 items-center">
                    {t("productdetail.form.specificationsContent")}{" "}
                    <span className="text-red-600 pl-1">(*)</span>
                    <Recommend
                      message={
                        t("productdetail.form.enterSpecificationsContent")
                      }
                    />
                  </FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterSpecificationsContentPlaceholder")
                      }
                      {...field}
                      onChange={(event) => {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="flex space-x-3 items-center">
                    {t("productdetail.form.featureDescription")}{" "}
                    <span className="text-red-600 pl-1">(*)</span>
                    <Recommend
                      message={
                        t("productdetail.form.featureDescriptionContent")
                      }
                    />
                  </FormLabel>
                  <FormControl>
                    <Textarea
                      disabled={loading}
                      placeholder={
                        t("productdetail.form.enterFeatureDescription")
                      }
                      {...field}
                    />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="flex space-x-3 items-center">
                    {t("productdetail.form.featureContent")}{" "}
                    <span className="text-red-600 pl-1">(*)</span>
                    <Recommend
                      message={
                        t("productdetail.form.featureContentDescription")
                      }
                    />
                  </FormLabel>
                  <FormControl>
                    <Textarea
                      disabled={loading}
                      placeholder={t("productdetail.form.enterFeatureContent")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
              ...
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productColor1")}
                        <span className="text-red-600 pl-1">(*)</span>
                      </FormLabel>
                      <Input
                        list="colors1"
                        ...
                        disabled={loading}
                        placeholder={t("productdetail.form.selectColor")}
                        className="border-2 border-orange-400 "
                      />
                      <datalist id="colors1">
                        {colors.map((color) => (
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productSize1")}
                        <span className="text-red-600 pl-1">(*)</span>
                      </FormLabel>
                      <Input
                        list="sizes1"
                        ...
                        disabled={loading}
                        placeholder={t("productdetail.form.selectSize")}
                        className="border-2 border-orange-400 "
                      />
                      <datalist id="sizes1">
                        {sizes.map((size) => (
              ...
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productColor2")}
                      </FormLabel>
                      <Input
                        list="colors2"
                        onChange={(e) => {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productSize2")}
                      </FormLabel>
                      <Input
                        list="sizes2"
                        onChange={(e) => {
              ...
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productColor3")}
                      </FormLabel>
                      <Input
                        list="colors3"
                        onChange={(e) => {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productSize3")}
                      </FormLabel>
                      <Input
                        list="sizes3"
                        onChange={(e) => {
              ...
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productColor4")}
                      </FormLabel>
                      <Input
                        list="colors4"
                        onChange={(e) => {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productSize4")}
                      </FormLabel>
                      <Input
                        list="sizes4"
                        onChange={(e) => {
              ...
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productColor5")}
                      </FormLabel>
                      <Input
                        list="colors5"
                        onChange={(e) => {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("productdetail.form.productSize5")}
                      </FormLabel>
                      <Input
                        list="sizes5"
                        onChange={(e) => {
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Input
                    ...
                    disabled={loading}
                    placeholder={t("productdetail.form.selectCategory")}
                  />
