...
const LabelForm: React.FC<LabelFormProps> = ({
  ...
  const formSchema = z.object({
    title: z
      .string()
      .min(2, { message: t("productdetail.form.min2Characters") }),
    promotionheading: z
      .string()
      .min(2, { message: t("productdetail.form.min2Characters") }),
    ...
    size1Id: z
      .string()
      .min(1, { message: t("productdetail.form.selectSize") }),
    color1Id: z
      .string()
      .min(0, { message: t("productdetail.form.selectColor") }),
    ...
    price1: z.coerce
      .number()
      .min(500, { message: t("productdetail.form.minPrice") }),
    ...
    categoryId: z
      .string()
      .min(1, { message: t("productdetail.form.selectCategory") }),
  });
  ...
  const onSubmit = async (datas: FormValues) => {
    ...
    try {
      ...
      setOpen(false);
      router.refresh()
      toast.success(t("productdetail.form.updateSuccess"));
    } catch (error: unknown) {
      if (
        ...
        <div>
          {field === "title" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    {t("productdetail.form.title")} <span className="text-red-600 pl-1">(*)</span>
                  </FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductName1")}
                      {...field}
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductPrice1")}
                      {...field}
                      className="border-2 border-orange-400 "
                    />
                  </FormControl>
          ...
          {field === "percentpromotion1" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                  {t("productdetail.form.productDiscount1")}
                    <span className="text-red-600 pl-1">(*)</span>
                  </FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductDiscount1")}
                      {...field}
                      className="border-2 border-orange-400 "
                    />
                  </FormControl>
          ...
          {field === "quantity1" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                  {t("productdetail.form.productQuantity1")}
                    <span className="text-red-600 pl-1">(*)</span>
                  </FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductQuantity1")}
                      {...field}
                      className="border-2 border-orange-400 "
                    />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductName2")}
                      {...field}
          ...
          {field === "price2" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productPrice2")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductPrice2")}
                      {...field}
                      className="border-2 border-green-400 "
                    />
                  </FormControl>
          ...
          {field === "percentpromotion2" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productDiscount2")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductDiscount2")}
                      {...field}
                      className="border-2 border-green-400 "
                    />
                  </FormControl>
          ...
          {field === "quantity2" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productQuantity2")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetaul.form.enterProductQuantity2")}
                      {...field}
                      className="border-2 border-green-400 "
                    />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductName3")}
                      {...field}
          ...
          {field === "price3" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productPrice3")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductPrice3")}
                      {...field}
                      className="border-2 border-sky-400 "
                    />
                  </FormControl>
          ...
          {field === "percentpromotion3" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productDiscount3")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductDiscount3")}
                      {...field}
                      className="border-2 border-sky-400 "
                    />
                  </FormControl>
          ...
          {field === "quantity3" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productQuantity3")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductQuantity3")}
                      {...field}
                      className="border-2 border-sky-400 "
                    />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductName4")}
                      {...field}
          ...
          {field === "price4" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productPrice4")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductPrice4")}
                      {...field}
                      className="border-2 border-violet-400 "
                    />
                  </FormControl>
          ...
          {field === "percentpromotion4" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productDiscount4")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductDiscount4")}
                      {...field}
                      className="border-2 border-violet-400 "
                    />
                  </FormControl>
          ...
          {field === "quantity4" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productQuantity4")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductQuantity4")}
                      {...field}
                      className="border-2 border-violet-400 "
                    />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductName5")}
                      {...field}
          ...
          {field === "price5" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productPrice5")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductPrice5")}
                      {...field}
                      className="border-2 border-pink-400 "
                    />
                  </FormControl>
          ...
          {field === "percentpromotion5" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('productdetail.form.productDiscount5')}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductDiscount5")}
                      {...field}
                      className="border-2 border-pink-400 "
                    />
                  </FormControl>
          ...
          {field === "quantity5" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.productQuantity5")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
                      placeholder={t("productdetail.form.enterProductQuantity5")}
                      {...field}
                      className="border-2 border-pink-400 "
                    />
                  </FormControl>
          ...
          {field === "promotionheading" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.bulkPromotion")}</FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterBulkPromotion")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
          ...
          {field === "promotiondescription" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.tenderPromotion")}</FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterTenderPromotion")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
          ...
          {field === "warranty1" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('productdetail.form.warrantyPrice1')}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
          ...
          {field === "warranty2" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.warrantyPrice2")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
          ...
          {field === "warranty3" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('productdetail.form.warrantyPrice3')}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
          ...
          {field === "warranty4" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.warrantyPrice4")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled={loading}
          ...
          {field === "descriptionspecifications" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    {t("productdetail.form.specification")} <span className="text-red-600 pl-1">(*)</span>
                  </FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterSpecification")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
          ...
          {field === "valuespecifications" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    {t("productdetail.form.specContent")}
                    <span className="text-red-600 pl-1">(*)</span>
                  </FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterSpecContent")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
          ...
          {field === "description2specifications" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.specification")}</FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterSpecification")}
          ...
          {field === "value2specifications" && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("productdetail.form.specContent")}</FormLabel>
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder={t("productdetail.form.enterSpecContent")}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      disabled={loading}
                      placeholder={t("productdetail.form.enterFeatureDescription")}
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
