...
const HeaderColumn = ({
  ...
  const translate = useTranslations("column.settingUser"); 
...
const RoleCell = <T extends SettingUsersColumn>({ row }: RoleCellProps<T>) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success(t("toastSuccess.changeSuccess"));
...
export const columns: ColumnDef<SettingUsersColumn>[] = [
...

  {
    ...
    header: ({ column }) => (
      <HeaderColumn
        column={column}
        labelKey="sendPasswordResetEmail"
        icon={SendHorizontal}
      />
    ),
    cell: ({ row }) => {
...

  {
    ...
    header: ({ column }) => (
      <HeaderColumn
        column={column}
        labelKey="sendResetPasswordToken"
        icon={SendHorizontal}
      />
    ),
    cell: ({ row }) => {
...

  {
    ...
    header: ({ column }) => (
      <HeaderColumn
        column={column}
        labelKey="sendTwoStepVerification"
        icon={SendHorizontal}
      />
    ),
    cell: ({ row }) => {
...

  {
    ...
    header: ({ column }) => (
      <HeaderColumn
        column={column}
        labelKey="sendUnbanNotification"
        icon={SendHorizontal}
      />
    ),
    cell: ({ row }) => {
...

  {
    ...
    header: ({ column }) => (
      <HeaderColumn
        column={column}
        labelKey="sendBanExpiredNotification"
        icon={SendHorizontal}
      />
    ),
    cell: ({ row }) => {
