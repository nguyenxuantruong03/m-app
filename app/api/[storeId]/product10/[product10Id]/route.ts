...
export async function GET(
  ...
  try {
    ...
    const product = await prismadb.product10.findUnique({
      where: {
...
export async function DELETE(
  ...
  try {
    ...
    const product = await prismadb.product10.delete({
      where: {
        id: params.product10Id,
      },
    });
...
export async function PATCH(
  ...
  try {
    ...
    await prismadb.product10.update({
      where: {
        id: params.product10Id,
      },
      data: {
    ...
    const product = await prismadb.product10.update({
      where: {
        id: params.product10Id,
      },
      data: {
