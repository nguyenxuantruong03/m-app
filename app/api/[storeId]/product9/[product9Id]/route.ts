...
export async function GET(
  ...
  try {
    ...
    const product = await prismadb.product9.findUnique({
      ...
      include: {
        images: true,
        imagesalientfeaturesproduct9: true,
        category: true,
        size: true,
        color: true,
      },
...
export async function DELETE(
  ...
  try {
    ...
    const product = await prismadb.product9.delete({
      where: {
        id: params.product9Id,
      },
    });
...
export async function PATCH(
  ...
  try {
    ...
    if (!imagesalientfeaturesproduct9 || !imagesalientfeaturesproduct9.length) {
    ...
    await prismadb.product9.update({
      where: {
        id: params.product9Id,
      },
      data: {
    ...
    const product = await prismadb.product9.update({
      where: {
        id: params.product9Id,
      },
      data: {
        ...
        imagesalientfeaturesproduct9: {
          createMany: {
            data: [
              ...imagesalientfeaturesproduct9.map(
