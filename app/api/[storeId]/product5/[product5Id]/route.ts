  ...
  try {
    if (!params.product5Id) {
      return new NextResponse(
        JSON.stringify({ error: "Product5 id is required!" }),
        { status: 400 }
      );
    }
    ...
    return new NextResponse(
      JSON.stringify({ error: "Internal error get product5." }),
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return new NextResponse(
      JSON.stringify({ error: "Internal error delete product5." }),
      { status: 500 }
    );
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    return new NextResponse(
      JSON.stringify({ error: "Internal error patch product5." }),
      { status: 500 }
    );
  }
}
