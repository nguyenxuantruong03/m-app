...
export async function GET(
  ...
  try {
    ...
    const product = await prismadb.product5.findUnique({
      ...
      include: {
        images: true,
        imagesalientfeaturesproduct5: true,
        category: true,
        size: true,
        color: true,
      },
...
export async function DELETE(
  ...
  try {
    ...
    const product = await prismadb.product5.delete({
      where: {
        id: params.product5Id,
      },
    });
...
export async function PATCH(
  ...
  try {
    ...
    if (!imagesalientfeaturesproduct5 || !imagesalientfeaturesproduct5.length) {
    ...
    await prismadb.product5.update({
      where: {
        id: params.product5Id,
      },
      data: {
    ...
    const product = await prismadb.product5.update({
      where: {
        id: params.product5Id,
      },
      data: {
        ...
        imagesalientfeaturesproduct5: {
          createMany: {
            data: [
              ...imagesalientfeaturesproduct5.map(
