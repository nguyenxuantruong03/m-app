...
export async function GET(
  ...
  try {
    ...
    return new NextResponse(
      JSON.stringify({ error: `${categoriesIdGetMessage.name4} 8` }),
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return new NextResponse(
      JSON.stringify({ error: `${categoriesIdDeleteMessage.name5} 8` }),
      { status: 500 }
    );
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    return new NextResponse(
      JSON.stringify({ error: `${categoriesIdPatchMessage.name6} 8` }),
      { status: 500 }
    );
  }
}
