...
export async function GET(
  ...
  try {
    ...
    const product = await prismadb.product11.findUnique({
      where: {
        id: params.product11Id,
      },
      include: {
        images: true,
        imagesalientfeaturesproduct11: true,
        category: true,
        size: true,
        color: true,
      },
...
export async function DELETE(
  ...
  try {
    ...
    const product = await prismadb.product11.delete({
      where: {
        id: params.product11Id,
      },
    });
...
export async function PATCH(
  ...
  try {
    ...
    if (!imagesalientfeaturesproduct11 || !imagesalientfeaturesproduct11.length) {
    ...
    await prismadb.product11.update({
      where: {
        id: params.product11Id,
      },
      data: {
    ...
    const product = await prismadb.product11.update({
      where: {
        id: params.product11Id,
      },
      data: {
        ...
        imagesalientfeaturesproduct11: {
          createMany: {
            data: [
              ...imagesalientfeaturesproduct11.map(
