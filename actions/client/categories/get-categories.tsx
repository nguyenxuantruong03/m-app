...
export const getCategories1 = async ():Promise<Category[]> =>{
...
export const getCategories2 = async ():Promise<Category[]> =>{
...
export const getCategories3 = async ():Promise<Category[]> =>{
...
export const getCategories4 = async ():Promise<Category[]> =>{
...
export const getCategories5 = async ():Promise<Category[]> =>{
...
export const getCategories6 = async ():Promise<Category[]> =>{
...
export const getCategories7 = async ():Promise<Category[]> =>{
...
export const getCategories8 = async ():Promise<Category[]> =>{
...
export const getCategories9 = async ():Promise<Category[]> =>{
...
export const getCategories10 = async ():Promise<Category[]> =>{
...
export const getCategories11 = async ():Promise<Category[]> =>{
...
export const getAllCategories = async () => {
    const [
        ...
        fetchCategories(URLCategories1),
        fetchCategories(URLCategories2),
        fetchCategories(URLCategories3),
        fetchCategories(URLCategories4),
        fetchCategories(URLCategories5),
        fetchCategories(URLCategories6),
        fetchCategories(URLCategories7),
        fetchCategories(URLCategories8),
        fetchCategories(URLCategories9),
        fetchCategories(URLCategories10),
        fetchCategories(URLCategories11)
    ]);
