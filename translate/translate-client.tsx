...
export const getCategoryNotFoundMessage = (language: string) => {
  switch (language) {
    case "vi":
  ...
  switch (language) {
    ...
    case "en":
      return {
        ...
        descriptionKimTin:
          "Kim Tin welding rods are high-quality rods manufactured by Kim Tin, specifically designed for welding metals such as steel, stainless steel, and other materials. These rods create strong, smooth welds and are highly durable. They are easy to use and provide consistent welding results. With excellent quality and competitive pricing, Kim Tin welding rods are popular in construction, mechanical, and repair industries.",

        titleInax: "Inax Shower Head",
        descriptionInax:
          "Inax shower heads are high-quality products designed with modern and elegant styles, suitable for any bathroom. With advanced technology, Inax shower heads save water while offering a refreshing and comfortable shower experience. Made from stainless steel or chrome-plated brass, they are rust-resistant and durable over time. Easy to install and maintain, Inax shower heads are an ideal choice for homes and construction projects.",
      };
    case "zh":
      return {
        titleCadivi: "Cadivi 电缆",
        descriptionCadivi:
          "Cadivi 电缆是 Cadivi 品牌的突出产品，专门提供高质量的电缆，适用于住宅和工业电气应用。采用纯铜材料，确保良好的导电性、安全性和耐用性。电缆具备防火和耐高温性能，符合国际质量标准。广泛应用于建筑工程、住宅电气系统和工业领域。",

        titleMPE: "MPE LED 灯",
        descriptionMPE:
          "MPE LED 灯泡节能，使用寿命长达 25,000 小时，减少更换和维护成本。稳定的光线，不闪烁，提供舒适的使用体验。该产品易于安装，适用于家庭和办公室。特别是，LED 灯环保，无有害物质，且可回收。是节能和提高照明质量的理想选择。",

        titleDienQuang: "Dien Quang 插座",
        descriptionDienQuang:
          "Dien Quang 插座是由越南著名品牌 Dien Quang 生产的高质量电气产品。该插座设计安全、坚固、易于使用，具有承受大负荷的能力，确保不发生短路或火灾。广泛应用于家庭、办公室和建筑工程。符合安全标准，具有高耐用性，提供便利和最优保护。",

        titleBinhMinh: "Binh Minh PVC 管",
        descriptionBinhMinh:
          "Binh Minh PVC 管是由 Binh Minh 管道公司生产的高质量塑料管。采用 PVC 和 uPVC 原料，具有高耐久性，能够承受高压和化学物质，广泛用于水管、电力和建筑系统。产品具有抗腐蚀、抗火性能，确保安全并节省维护成本。是住宅和工业项目的可靠选择。",

        titleSenko: "Senko 风扇",
        descriptionSenko:
          "Senko 风扇是越南知名的电风扇产品，以现代设计、耐用性和高效的制冷性能著称。Senko 风扇采用先进技术制造，确保安全、节能、安静运行。多种款式可选，包括立式风扇、壁挂风扇和箱式风扇，适合不同空间的使用。凭借稳定的质量和合理的价格，深受消费者信赖。",

        titleApolo: "Apolo 胶水",
        descriptionApolo:
          "Apolo 胶水是广泛应用于工业和家庭领域的高质量粘合剂。采用特殊配方，Apolo 胶水具有强大的粘结力、快速干燥和良好的耐力，适用于木材、金属、陶瓷、塑料等材料的粘接。无毒、安全且环保。凭借高效、耐用和合理的价格，深受用户喜爱。",

        titleATM: "ATM 喷漆",
        descriptionATM:
          "ATM 喷漆是一款高质量的喷涂产品，适用于装饰和保护各种表面。具有良好的附着力，干燥迅速，能形成光滑、耐久的涂层。适用于金属、木材、塑料和陶瓷等多种材料，使用简便，覆盖力强。是快速项目和修复工作的理想选择。",

        titlePinConO: "Con O 电池",
        descriptionPinConO:
          "Con O 电池是越南生产的高质量电池，以稳定、持久的能量供应著称。多种类型适用于电子设备、玩具、手电筒和家电。凭借长寿命、防漏设计和环保性能，深受消费者喜爱。Con O 电池提供便利和节省日常使用成本。",

        titleDaCat: "Hải Dương 切割片",
        descriptionDaCat:
          "Hải Dương 切割片是高质量的切割工具，适用于切割金属、石材、混凝土和陶瓷等材料。该切割片锋利、快速且精准，能够节省时间和精力。广泛应用于建筑、金属加工和维修行业。凭借持久的耐用性和稳定的性能，Hải Dương 切割片是用户的可靠选择。",

        titleVietTiep: "Viet Tiep 锁",
        descriptionVietTiep:
          "Viet Tiep 锁是越南知名的锁具品牌，以耐用性和高安全性著称。采用坚固的合金钢制造，抗切割和冲击，确保财产安全。Viet Tiep 锁有多种型号，适用于家庭、办公室和建筑项目。凭借稳固的设计和易于使用，Viet Tiep 锁是有效保护财产的可靠选择。",

        titleKimTin: "Kim Tin 焊条",
        descriptionKimTin:
          "Kim Tin 焊条是 Kim Tin 品牌生产的高质量焊条，专为焊接钢、特钢、不锈钢等金属材料设计。焊条能够创造稳固、平滑的焊接接头，具有出色的耐用性，使用简便，焊接效果稳定。凭借卓越的质量和竞争力的定价，Kim Tin 焊条在建筑、机械和维修行业中广受欢迎。",

        titleInax: "Inax 花洒",
        descriptionInax:
          "Inax 花洒是高质量的产品，设计现代、优雅，适合任何浴室。采用先进技术，Inax 花洒节水，同时提供舒适清新的淋浴体验。采用不锈钢或镀铬铜材料，防锈耐用。安装和维护方便，Inax 花洒是家庭和建筑项目的理想选择。",
      };
    ...
    case "fr":
      return {
        ...
        descriptionVietTiep:
          "Les verrous Viet Tiep sont des produits de sécurité très réputés au Vietnam, connus pour leur solidité et leur sécurité élevée. Fabriqués en acier allié résistant, ils sont anti-coupe et anti-choc, garantissant la sécurité des biens. Disponibles en plusieurs types, ces verrous conviennent aux maisons, bureaux et projets de construction. Avec leur design robuste et leur facilité d'utilisation, les verrous Viet Tiep sont un choix fiable pour protéger les biens efficacement.",

        titleKimTin: "Barres de soudure Kim Tin",
        descriptionKimTin:
          "Les barres de soudure Kim Tin sont des produits de haute qualité fabriqués par la marque Kim Tin, spécialement conçues pour souder des métaux comme l'acier, l'acier inoxydable et d'autres matériaux. Elles créent des soudures solides et lisses et sont très durables. Faciles à utiliser, elles offrent des résultats de soudure constants. Avec une excellente qualité et un prix compétitif, les barres de soudure Kim Tin sont populaires dans les secteurs de la construction, de la mécanique et de la réparation.",

        titleInax: "Douche Inax",
        descriptionInax:
          "Les douches Inax sont des produits de haute qualité, au design moderne et élégant, adaptées à toutes les salles de bain. Grâce à une technologie avancée, les douches Inax économisent de l'eau tout en offrant une expérience de douche rafraîchissante et agréable. Fabriquées en acier inoxydable ou en laiton chromé, elles sont résistantes à la rouille et durables. Faciles à installer et à entretenir, les douches Inax sont un choix idéal pour les foyers et les projets de construction.",
      };
    ...
    case "ja":
      return {
        ...
        descriptionCadivi:
          "Cadivi ケーブルは、住宅用および産業用の高品質な電気ケーブルを提供するCadiviブランドの代表的な製品です。純銅製で、優れた導電性、安全性、耐久性を保証します。耐火性および耐熱性があり、国際的な品質基準に準拠しています。建設プロジェクト、住宅の電気システム、産業分野で広く使用されています。",

        titleMPE: "MPE LED ランプ",
        descriptionMPE:
          "MPE LED ランプは省エネで、25,000時間の長寿命を提供し、交換とメンテナンスコストを削減します。安定した光を提供し、ちらつきがなく、使用者に快適さをもたらします。家庭やオフィスに適した簡単な設置が可能です。また、環境に優しく、有害物質を含まず、リサイクル可能です。エネルギーを節約し、照明の質を向上させる理想的な選択肢です。",

        titleDienQuang: "Dien Quang コンセント",
        descriptionDienQuang:
          "Dien Quang コンセントは、ベトナムの有名ブランドDien Quangが製造する高品質の電気製品です。安全で堅牢、使いやすい設計で、大きな負荷にも耐え、ショートや火災を防ぎます。家庭、オフィス、建設現場で広く使用されており、高い安全基準と耐久性を備え、便利で最適な保護を提供します。",

        titleBinhMinh: "Binh Minh PVC パイプ",
        descriptionBinhMinh:
          "Binh Minh PVC パイプは、Binh Minh Pipe Companyによって製造された高品質なパイプです。PVCとuPVC素材で作られ、高耐久性、圧力および化学物質への耐性があります。水道、電力、建設システムで広く使用されています。この製品は腐食、火災に強く、安全で維持コストを節約します。住宅や産業プロジェクトで信頼性のある選択肢です。",

        titleSenko: "Senko 扇風機",
        descriptionSenko:
          "Senko 扇風機は、ベトナムで広く知られている電動ファンで、現代的なデザイン、耐久性、高い冷却性能で有名です。Senkoのファンは最新技術を使用して製造され、安全でエネルギー効率が良く、静かな動作を保証します。スタンディングファン、ウォールファン、ボックスファンなど、様々な種類があり、異なる空間の冷却ニーズに対応しています。安定した品質と手頃な価格で、消費者に信頼されています。",

        titleApolo: "Apolo 接着剤",
        descriptionApolo:
          "Apolo 接着剤は、産業および家庭用に広く使用される高品質な接着剤です。特別なフォーミュラにより、Apolo 接着剤は強力な接着力、速乾性、および優れた耐力を提供し、木材、金属、セラミック、プラスチックなどの材料に適しています。無毒で、安全で環境に優しく、効率的で耐久性があり、手頃な価格で広く愛されています。",

        titleATM: "ATM スプレー塗料",
        descriptionATM:
          "ATM スプレー塗料は、表面の装飾と保護ニーズに対応する高品質なスプレー塗料です。良好な付着力、速乾性、滑らかで耐久性のある仕上がりを提供します。金属、木材、プラスチック、セラミックなどの材料に適しており、使いやすく高いカバー力を持っています。短期間のプロジェクトや修理に理想的な選択肢です。",

        titlePinConO: "Con O 電池",
        descriptionPinConO:
          "Con O 電池は、ベトナム製の高品質な電池で、安定した長寿命のエネルギー供給を提供します。多種類があり、電子機器、玩具、懐中電灯、家庭用電化製品などに適しています。長寿命、漏れ防止、環境に優しい特徴で信頼されています。日常使用に便利でコスト効果の高い選択肢です。",

        titleDaCat: "Hải Dương 切断ディスク",
        descriptionDaCat:
          "Hải Dương 切断ディスクは、高品質で耐久性のある材料で作られており、金属、石材、コンクリート、陶器などの材料を切断するために設計されています。鋭い切れ味、高速性、精密さを提供し、時間と労力を節約できます。建設業、金属加工業、修理業で広く使用されています。長持ちする耐久性と安定したパフォーマンスを提供する信頼性の高い選択肢です。",

        titleVietTiep: "Viet Tiep 錠前",
        descriptionVietTiep:
          "Viet Tiep 錠前は、ベトナムの有名な錠前ブランドで、耐久性と高いセキュリティで知られています。強固な合金鋼で作られており、切断や衝撃に強く、財産を安全に守ります。家庭、オフィス、建設現場で利用可能で、頑丈な設計と使いやすさが特徴です。財産を守るための効果的な選択肢です。",

        titleKimTin: "Kim Tin 溶接棒",
        descriptionKimTin:
          "Kim Tin 溶接棒は、Kim Tin ブランドによる高品質な溶接棒で、鉄鋼、ステンレス鋼などの金属を溶接するために設計されています。溶接ジョイントは強力で滑らかで、耐久性も抜群です。使いやすく、安定した溶接効果を提供します。優れた品質と競争力のある価格で、建設業、機械工業、修理業で広く使用されています。",

        titleInax: "Inax シャワー",
        descriptionInax:
          "Inax シャワーは、高品質な製品で、モダンでエレガントなデザインが特徴です。最新の技術を使い、水を節約しながらも快適なシャワー体験を提供します。ステンレススチールやクロムメッキ銅製で、耐錆性があり、耐久性もあります。取り付けやメンテナンスが簡単で、家庭や建設プロジェクトに最適な選択肢です。",
      };
    default:
      return {
        titleCadivi: "Cadivi Electrical Cable",
...
export const getShowHide = (language: string) => {
  switch (language) {
    case 'vi':
      return {
        hide: "Ẩn",
...
export const getProductDescriptionMeta = (language: string, product: Product) => {
  switch (language) {
    case 'vi': 
        return `Khám phá thông tin về sản phẩm ${product.heading}.`;
    case 'en': 
        return `Explore information about the product ${product.heading}.`;
    case 'zh': 
        return `探索有关产品 ${product.heading} 的信息。`;
    case 'fr': 
        return `Découvrez les informations sur le produit ${product.heading}.`;
    case 'ja': 
        return `製品 ${product.heading} についての情報を探る。`;
    default: 
        return `Explore information about the product ${product.heading}.`;
}
}
