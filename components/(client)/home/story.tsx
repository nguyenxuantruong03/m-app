      ...
      <Container>
        <div className="mx:auto xl:grid xl:grid-cols-2 ">
          ...
          <div className="p-5 xl:my-20">
            ...
            <div>
              <h2 className="font-bold text-slate-900 dark:text-slate-200">Ngày thành lập:</h2>
              ...
              <h2 className="font-bold text-slate-900 dark:text-slate-200">Chuyên bán mặt hàng:</h2>
              <p className="text-slate-900 dark:text-slate-200">
              ...
              <h2 className="font-bold text-slate-900 dark:text-slate-200">Cam Kết Chất Lượng:</h2>
              <p className="text-slate-900 dark:text-slate-200">
              ...
              <div className="flex">
              <p className="font-bold text-slate-900 dark:text-slate-200">Địa chỉ: </p>  <p className="ml-2 text-slate-400"> 457 Lê Văn Quới, Phường Bình Trị Đông A, Quận Bình Tân, TpHCM</p>
              </div>
              <div className="flex">
              <p className="font-bold text-slate-900 dark:text-slate-200">Điện thoại:</p> <p className="ml-2 text-slate-400">0352261103</p>
              </div>
              <div className="flex">
              <p className="font-bold text-slate-900 dark:text-slate-200">Email:</p> <p className="ml-2 text-slate-400">nxt159753@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
