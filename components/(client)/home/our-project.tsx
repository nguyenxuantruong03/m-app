      ...
      <Container>
        ...
        <div className=" grid grid-cols-3 ">
          <div className="space-y-4 mx-1 md:mx-3">
            <div className="relative inline-block group w-full h-[140px] md:h-[240px] cursor-pointer" onClick={handleClickProduct}>
              <Image
                fill
                alt="image"
              ...
              <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="text-white font-extrabold text-2xl">Phòng ăn</p>
              </div>
            </div>
            <div className="relative inline-block group w-full h-[140px] md:h-[240px] cursor-pointer" onClick={handleClickProduct}>
              <Image
              ...
              />
              <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="text-white font-extrabold text-2xl">Phòng khách</p>
              </div>
            </div>
          </div>
          <div className="space-y-4 mx-1 md:mx-3">
          <div className="relative inline-block group  w-full h-[140px] md:h-[240px] cursor-pointer" onClick={handleClickProduct}>
              ...
              />
              <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="text-white font-extrabold text-2xl">Đường ống nước</p>
              </div>
            </div>
            <div className="relative inline-block group w-full h-[140px] md:h-[240px] cursor-pointer" onClick={handleClickProduct}>
              <Image
              ...
              />
              <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="text-white font-extrabold text-2xl">Đường dây điện</p>
              </div>
            </div>
          </div>
          <div className="space-y-4 mx-1 md:mx-3">
          <div className="relative inline-block group  w-full h-[140px] md:h-[240px] cursor-pointer" onClick={handleClickProduct}>
              ...
              />
              <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="text-white font-extrabold text-2xl">Đèn trần</p>
              </div>
            </div>
            <div className="relative inline-block group w-full h-[140px] md:h-[240px] cursor-pointer" onClick={handleClickProduct}>
              <Image
              ...
              />
              <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="text-white font-extrabold text-2xl">VLXD công trình</p>
              </div>
            </div>
          </div>
        </div>
