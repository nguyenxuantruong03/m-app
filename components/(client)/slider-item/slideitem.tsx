...
import { getCategories, getCategories1, getCategories10, getCategories11, getCategories2, getCategories3, getCategories4, getCategories5, getCategories6, getCategories7, getCategories8, getCategories9 } from "@/actions/client/categories/get-categories";
...
const SlideItem = async () => {
  ...
  const billboardmini = await getBillboard(
    "f4ad613b-e77a-4f79-969a-32017dc278a5"
  );
  const billboardsale = await getBillboard(
    "c549dc49-35a3-466d-ba22-272a2b3e2ce3"
  );
  const billboardsaleipad = await getBillboard(
    "0081ff49-2a20-49e9-addf-1ab48b54a0ff"
  );
  const billboardsalemobile = await getBillboard(
