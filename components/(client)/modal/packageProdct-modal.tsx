...
export const PackageModal: React.FC<AlertModalProps> = ({
  ...
  return (
    <Modal
      title={title || "Sản phẩm hết hàng"}
      description={
        message || "Chúng tôi sẽ không thêm sản phẩm đã hết vào giỏ hàng!"
      }
      isOpen={isOpen}
      onClose={onClose}
    >
                ...
                >
                  {loading ? (
                    <span className="flex items-center">
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" /> Thêm sản
                      phẩm
                    </span>
                  ) : (
                    "Đồng ý"
