...
import "./delivery.css";
import { Home, AlignLeft, Heart, ShoppingCart, TicketPercent, PackageSearch, Blocks } from "lucide-react";
...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    if (path === "/") {
      ...
      handleItemClick(3);
    } else if(path === "/utility" || path.startsWith("/warehouse") || path === "/spinlucky"){
      handleItemClick(4);
    } else {
