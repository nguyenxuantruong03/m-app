...
import { translateRelatedTagQuat } from "@/translate/translate-client";

interface RelatedTagQuatProps {
  languageToUse: string;
}

const RelatedTagQuat = ({ languageToUse }: RelatedTagQuatProps) => {
  //language
  const relatedTagQuatMessage = translateRelatedTagQuat(languageToUse);
  return (
