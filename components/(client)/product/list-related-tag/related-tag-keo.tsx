...
import { translateRelatedTagKeo } from "@/translate/translate-client";

interface RelatedTagKeoProps {
  languageToUse: string;
}

const RelatedTagKeo = ({ languageToUse }: RelatedTagKeoProps) => {
  //language
  const relatedTagKeoMessage = translateRelatedTagKeo(languageToUse);
  return (
