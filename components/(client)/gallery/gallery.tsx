      ...
      {isModalOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={closeModal}
              className="absolute top-2 right-2 w-10 h-10 rounded-full text-gray-400 hover:text-slate-900 hover:bg-gray-400 hover:bg-opacity-20 cursor-pointer text-xl"
            >
              &times;
            </button>
